...
public class OopPrinciples{
  ...
  public static void main(String[] args){
    ...
    final String[][] arrayWithHeader = {
      ...
      {"PLANE", "Boeing", "737", "85-215 seats", "10204 km", "1966–present", "36 m", "11300 m"},
      {"PLANE", "Boeing", "787", "210-330 seats", "14800 km", "2007–present", "60.12 m", "13100 m"},
      {"PLANE", "Airbus", "A380", "544 seats", "15200 km", "2005–present", "80 m", "13100 m"},
      {"PLANE", "Airbus", "A330", "406 seats", "13450 km", "1992–present", "60.3 m", "12500 m"},
    ...
    for (int i = 0; i < 24; i++) {
      ...
      if (arrayWithHeader[i][0].equals("PERSON")) {
        ...
        System.out.println("CEILING: " + arrayWithHeader[i][7]);
