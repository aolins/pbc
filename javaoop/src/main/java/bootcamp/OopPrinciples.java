...
public class OopPrinciples {
  ...
  public static void main(String[] args){
    ...
    final Printable[] arrayOfPrintables = {
      ...
      new Car("BMW", "X6", 2016, "Premium Gasoline", 567, 5.2, 51),
      new Car("SAAB", "9-7X", 2009, "Regular Gasoline", 285, 7.2, 20),
      new Car("CADILLAC", "XT5", 2017, "Regular Gasoline", 310, 6.6, 55),
      new Plane("Boeing", "737", "85-215 seats", 10204, "1966-present", 36.0, 11300, 885),
      new Plane("Boeing", "787", "210-330 seats", 14800, "2007-present", 60.12, 13100, 880),
      new Plane("Airbus", "A380", "544 seats", 15200, "2005-present", 80.0, 13100, 881),
      new Plane("Airbus", "A330", "406 seats", 13450, "1992-present", 60.3, 12500, 854),
    ...
    System.out.println("The speed of the car is as expected! Expected 59, and was " + car.speed);
    car.printSpeed();
    ...
    System.out.println("The speed of the car is NOT as expected! Expected 61, and was " + car.speed);
  }
}
